...
public class PostagemController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Postagem> getById(@PathVariable Long id){  //@pathVariable pega o id da linha anterior
		return postagemRepository.findById(id)
				.map(resposta -> ResponseEntity.ok(resposta)) //Optional Map
